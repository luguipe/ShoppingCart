...
const Products = (props) => {
  ...
  const restockProducts = (url) => {
    ...
    let newItems = data.data.map((item) => {
      let { cost, country, instock, name } = item.attributes;
...
//       console.log(`restockProducts: ${name}`);
//       console.log(`restockProducts: ${country}`);
//       console.log(`restockProducts: ${cost}`);
//       console.log(`restockProducts: ${instock}`);
